...
# ╔═╡ 0e90d198-6add-11ec-055c-0d59b59a6d35
begin
	using CitableBase
	using CitableObject
	using CitableText
...
> *Configuration*
>
> Read the CEX data of the HMT release into a single string
"""

# ╔═╡ b8f35494-cf52-4c45-ac54-593eebe22a32
hmtrelease = "https://raw.githubusercontent.com/homermultitext/hmt-archive/master/releases-cex/hmt-2020i.cex"

# ╔═╡ 8c9c2111-8f52-442a-b2a6-1c41764fe070
cexstring = HTTP.get(hmtrelease).body |> String

# ╔═╡ 1c84967d-884e-45d0-82cf-96f1276c0b45
md"""
# Read a library

Additional packages we need to build the library:


1. `CitablePhysicalText`
4. `CitableImage`
8. possibly concrete readers and builders


Once these are in place, we can manually do what can be rolled in to `EditorsRepo`.


For testing:

1. `Orthography`
2. some concrete orthography
...
md"Construct a corpus from CEX of an HMT release:"

# ╔═╡ a7c4cbe9-d605-4278-a33b-1718e3d8a4ad
fromcex(cexstring, CitableTextCorpus, delimiter = "#")
...
[compat]
CitableBase = "~8.0.0"
CitableCorpus = "~0.10.0"
CitableObject = "~0.11.0"
CitableTeiReaders = "~0.7.4"
CitableText = "~0.14.1"
EditionBuilders = "~0.6.3"
HTTP = "~0.9.17"
PlutoUI = "~0.7.27"
"""
...
git-tree-sha1 = "a01fcedd667d2fffd6a500fc4101bd6d57b9e8ed"
uuid = "d6f014bd-995c-41bd-9893-703339864534"
version = "8.0.0"

[[deps.CitableCorpus]]
deps = ["CitableBase", "CitableText", "CiteEXchange", "DataFrames", "DocStringExtensions", "Documenter", "HTTP", "Test"]
git-tree-sha1 = "c659a617576fe93e416e32846eda37e4d45c8d07"
uuid = "cf5ac11a-93ef-4a1a-97a3-f6af101603b5"
version = "0.10.0"

[[deps.CitableObject]]
deps = ["CitableBase", "DocStringExtensions", "Documenter", "Test"]
git-tree-sha1 = "c373a51bf3330a45850a5aeffab9f78eb8f4e68c"
...
git-tree-sha1 = "436d74e84888e05afd9ec8cef3fc93bff25981cf"
uuid = "b4325aa9-906c-402e-9c3f-19ab8a88308e"
version = "0.7.4"

[[deps.CitableText]]
deps = ["CitableBase", "DocStringExtensions", "Documenter", "Test"]
git-tree-sha1 = "55b27a2d06a7a74ada52bf69cd4328bf771acbde"
uuid = "41e66566-473b-49d4-85b7-da83b66615d8"
version = "0.14.1"

[[deps.CiteEXchange]]
deps = ["CSV", "CitableBase", "DocStringExtensions", "Documenter", "HTTP", "Test"]
git-tree-sha1 = "dfba1f3eb83e5c5fb9c3bcb0904f0e205e1d8af0"
...
deps = ["CitableCorpus", "CitableText", "DocStringExtensions", "Documenter", "EzXML", "Test"]
git-tree-sha1 = "646c7010e96a900911092effda7f0d2335231d9f"
