...
# ╔═╡ 0f24b1e6-1abc-4fbe-b9e0-6b1973317187
html"<hr/><hr/><br/><br/><br/><br/>"
...
function orthography()
	if isempty(surface)
		...
		for row in eachrow(sdse)
			...
			title = "Iliad" #worktitle(catalog, row.passage)
...
begin
	...
	if surface == ""
		...
		surfDse = EditorsRepo.surfaceDse(editorsrepo(), Cite2Urn(surface) )
		cellout = []
...
CitableTeiReaders = "~0.6.5"
CitableText = "~0.9.0"
DataFrames = "~1.2.2"
EditionBuilders = "~0.4.5"
EditorsRepo = "~0.12.1"
HTTP = "~0.9.14"
...
git-tree-sha1 = "4dad52d19f8d3891b9b410e53f9f479240b6d275"
...
git-tree-sha1 = "1010fb35731333b1c5f75b32559bf2984f1a4f73"
...
[[EditionBuilders]]
deps = ["CitableCorpus", "CitableText", "DocStringExtensions", "Documenter", "EzXML", "Test"]
git-tree-sha1 = "d1d3ff252f39b90d32b30e8fa30a942a9c1dc3bc"
...
git-tree-sha1 = "03845b4218f3d959148d3ccaa0038b8b81b73f96"
